        ...
        For i = 0 To lstObject.ListCount - 1
            If lstObject.Selected(i) = True Then
                ...
                Case "Click"
                    ...
                    strSrc = strSrc & vbCrLf & "    DomSleepWhileBusy objIE, 500"
                Case "Input"
                ...
                Case "Submit"
                    ...
                    strSrc = strSrc & vbCrLf & "    DomSleepWhileBusy objIE"
                Case "Download"
                    ...
                    End If
                Case "Navigate2"
                    strSrc = strSrc & vbCrLf & "    objIE.Navigate2 " & strctNode(i).src
                Case "Checked"
...
Private Sub cmdConfirmURL_Click()
    
    Dim objConfirmIE As Object
    Set objConfirmIE = CreateObject("InternetExplorer.Application")
    objConfirmIE.Visible = True
    objConfirmIE.Navigate2 txtURL.Text
    
    Set objConfirmIE = Nothing
